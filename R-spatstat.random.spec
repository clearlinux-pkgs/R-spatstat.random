...
Version  : 3.4.1
Release  : 30
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/spatstat.random_3.4-1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/spatstat.random_3.4-1.tar.gz
...
popd
pushd ..
cp -a spatstat.random buildavx512
popd
pushd ..
cp -a spatstat.random buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747789169
...
/usr/lib64/R/library/spatstat.random/info/packagesizes.txt
...
/V4/usr/lib64/R/library/spatstat.random/libs/spatstat.random.so
/VA/usr/lib64/R/library/spatstat.random/libs/spatstat.random.so
